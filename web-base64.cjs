...
// Support decoding URL-safe base64 strings,: Node.js does.
...
module.exports.byteLength = function byteLength (b64) {
 ...
 * @returns {ArrayBuffer} The binary data: an `ArrayBuffer`.
 */
module.exports.toByteArray = function toByteArray (b64) {
  let tmp
  const [validLen, placeHoldersLen] = getLens(b64)
 ...
 * @returns {string} The contents of `typedArray`: a Base64 string.
 */
module.exports.fromByteArray = function fromByteArray (arrayBuffer, urlFriendly = false) {
  let tmp
